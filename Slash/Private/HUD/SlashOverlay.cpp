...
void USlashOverlay::SetGold(int32 Gold)
{
	if (GoldText)
	{
		// Converting int32 into text and setting GoldText variable
...
void USlashOverlay::SetConsumable(int32 Potions)
{
	if (ConsumableNum)
	{
		ConsumableNum->SetText(FText::FromString(FString::Printf(TEXT("%d"), Potions)));
	}
}
